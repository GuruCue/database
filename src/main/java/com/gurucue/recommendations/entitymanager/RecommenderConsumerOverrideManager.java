...
public interface RecommenderConsumerOverrideManager {
    RecommenderConsumerOverride getByConsumerAndOriginalPartnerRecommender(Consumer consumer, PartnerRecommender partnerRecommender);
}
