...
@Deprecated
public class TvChannelInfo implements Info {
    public final TvChannelProduct tvChannel;
    public final List<PackageProduct> productPackages;

    public TvChannelInfo(final TvChannelProduct tvChannel, final List<PackageProduct> productPackages) {
        this.tvChannel = tvChannel;
        this.productPackages = productPackages;
    }

    @Override
    public TvChannelProduct getPrimaryPartnerProduct() {
        return tvChannel;
    }
}
