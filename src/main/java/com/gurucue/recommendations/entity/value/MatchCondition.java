...
/**
 * Contains all the conditions that a matcher key requires to match.
 */
public final class MatchCondition {
    ...
    public MatchCondition(final long productTypeId, AttributeValues attributes, AttributeValues related) {
