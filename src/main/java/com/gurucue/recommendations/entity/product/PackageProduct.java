...
public final class PackageProduct extends Product {
    public final TranslatableValue title;
    public final boolean isAdult; // default: false
    public final String[] tvChannelCodes;
    public final String[] vodCodes;
    public final String[] interactiveCodes;
    ...
    public PackageProduct(
        ...
        tvChannelCodes = attributes.getAsStrings(attributeCodes.tvChannelId);
        vodCodes = attributes.getAsStrings(attributeCodes.svodId);
        interactiveCodes = attributes.getAsStrings(attributeCodes.interactiveId);
    }
}
