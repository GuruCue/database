...
public class RelationType implements Serializable {
    private static final long serialVersionUID = -88208134592764033L;
    ...
    public RelationType(final Long id, final String identifier) {
        this.id = id;
    ...
    public String toString() {
        return "RelationType(id=" + (null == getId() ? "null" : getId().toString()) +
